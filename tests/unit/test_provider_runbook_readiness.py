...
def test_provider_runbook_readiness_reports_operational_gaps() -> None:
    ...
    assert readiness.completed_required_item_count == 5
    ...
    assert readiness.items[5].runbook_id == "provider_embedding_rollout_and_recovery"
    assert readiness.items[6].runbook_id == "provider_degradation_and_circuit_response"
