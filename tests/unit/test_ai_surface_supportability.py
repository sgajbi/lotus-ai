...
def test_ai_surface_supportability_summary_is_source_backed_and_bounded() -> None:
    ...
    assert summary.supported_surface_count == 16
    assert summary.executable_workflow_pack_count == 16
    assert summary.action_required_surface_count == 16
    ...
    assert {item.surface_id: item.owning_service for item in summary.surfaces} == {
        ...
        "advisory_copilot_client_follow_up_draft": "lotus-advise",
        "advisory_copilot_compliance_review_summary": "lotus-advise",
        "advisory_copilot_evidence_qa": "lotus-advise",
        "advisory_copilot_meeting_preparation": "lotus-advise",
        "advisory_copilot_operations_report_handoff": "lotus-advise",
        "advisory_copilot_proposal_explanation": "lotus-advise",
