...
def reset_runtime_settings() -> Generator[None, None, None]:
    original_values = {
        ...
        "live_text_fallback_api_base": settings.live_text_fallback_api_base,
        "live_text_fallback_api_key": settings.live_text_fallback_api_key,
        ...
        "caller_jwt_audience": settings.caller_jwt_audience,
        "caller_jwt_public_keys": settings.caller_jwt_public_keys,
