...
- platform task APIs now also expose a bounded execution-summary view built from persisted audit records, so real task usage can be measured instead of inferred,
