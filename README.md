...
4. deployment split now has governed runtime and rollout surfaces, and resilience now has a bounded runtime inventory surface, while embeddings expansion and document ingestion remain roadmap items.
