...
4. a bounded observability foundation is now available through `/platform/observability/runtime-status`, but the broader observability rollout remains in progress.
