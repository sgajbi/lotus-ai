...
4. deployment split now has governed runtime and rollout surfaces, and resilience now has both a bounded runtime inventory surface and an ordered restore-plan surface, while embeddings expansion and document ingestion remain roadmap items.
