...
11. `GET /platform/safety/governance-status` for the combined safety rollout view,
12. `GET /platform/retrieval/runtime-status` for retrieval-specific persistence and corpus posture when retrieval features are relevant.
