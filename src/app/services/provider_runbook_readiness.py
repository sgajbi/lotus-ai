    ...
    items = [
        ...
        ProviderRunbookReadinessItem(
            ...
            notes=(
                ...
                "responses are not yet documented, including how operators review and reset durable quota state safely."
            ),
        ),
        ProviderRunbookReadinessItem(
            ...
            notes=(
                ...
                "are not yet documented, including how durable spend posture is reviewed and recovered safely."
            ),
        ),
        ProviderRunbookReadinessItem(
        ...
        ProviderRunbookReadinessItem(
            ...
            notes=(
                ...
                "and safe re-enable procedures are not yet documented, including durable circuit-state recovery."
            ),
        ),
        ProviderRunbookReadinessItem(
