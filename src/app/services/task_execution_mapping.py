    ...
    *,
    ...
    return TaskExecutionResponse(
        ...
        audit=TaskAuditMetadata(
            ...
            estimated_cost_usd=resolved.provider_execution.estimated_cost_usd,
            rate_card_ref=resolved.provider_execution.rate_card_ref,
...
def map_audit_record(
    *,
    ...
    return AuditRecordResponse(
        ...
        estimated_cost_usd=response.audit.estimated_cost_usd,
        rate_card_ref=response.audit.rate_card_ref,
